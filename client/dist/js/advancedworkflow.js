	...
	$("#Root_PublishingSchedule").entwine({
		...
		checkEmbargo: function checkEmbargo(publishDate, publishTime, parent) {
			...
			if (noPublishDate && noPublishTime) {
				...
				if (publishDate === '') {
					message = ss.i18n.sprintf(ss.i18n._t('Workflow.EMBARGOMESSAGETIME'), publishTime);
				} else if (publishTime === '') {
					message = ss.i18n.sprintf(ss.i18n._t('Workflow.EMBARGOMESSAGEDATE'), publishDate);
				} else {
					message = ss.i18n.sprintf(ss.i18n._t('Workflow.EMBARGOMESSAGEDATETIME'), publishDate, publishTime);
				}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bundles_advanced_workflow_cms_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bundles_advancedworkflow_management_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_bundles_WorkflowField_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bundles_WorkflowGridField_js__ = __webpack_require__(3);
